...
class Bayes_Classifier:
    ...
    def __init__(self):
      ...
      is ready to classify input text."""
        if (os.path.exists("negative1.txt") and os.path.exists("positive1.txt")):
            self.posDict = self.load("positive1.txt")
            self.negDict = self.load("negative1.txt")
        else:
            self.posDict = {}
            self.negDict = {}
            self.train()
    ...
    def train(self):
        ...
        for fFileObj in os.walk("movies_reviews/"):
            ...
            for fileName in enumerate(len(IFileList)):
                star = fileName[7]
                #print star
        ...
        self.save(self.negDict, "negative1.txt")
        self.save(self.posDict, "positive1.txt")
